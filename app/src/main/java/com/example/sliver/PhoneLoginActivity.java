  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    sendVerificationCodeButton.setOnClickListener(
        view -> {
          ...
          if (TextUtils.isEmpty(phoneInputValue)) {
            Toast.makeText(
                    PhoneLoginActivity.this, "Please enter your phone number!", Toast.LENGTH_SHORT)
                .show();
          } else {
    ...
    verifyButton.setOnClickListener(
        view -> {
          ...
          String verificationCode = verificationCodeInput.getEditText().getText().toString().trim();
